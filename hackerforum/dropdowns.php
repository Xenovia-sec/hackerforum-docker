...
<nav class=" navbar navbar-expand-lg navbar-custom">
    ...
    <div class="container-fluid">
        <!-- Toggle button -->
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-mdb-target="#navbarLeftAlignExample" aria-controls="navbarLeftAlignExample" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarLeftAlignExample">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active navbar-text2" aria-current="page" href="index.php"><img src="assets/img/forum-logo.gif"></a>
                </li>
                <li class="nav-item dropdown d-flex align-items-center d-flex align-items-center">
                    <a class="nav-link dropdown-toggle navbar-text" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fa-solid fa-earth-europe"></i> General
                    </a>
                    <!-- Dropdown menu -->
                ...
                <li class="nav-item dropdown d-flex align-items-center">
                    <a class="nav-link dropdown-toggle navbar-text" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fa-solid fa-database"></i> Leaks
                    </a>
                    <!-- Dropdown menu -->
                ...
                <li class="nav-item dropdown d-flex align-items-center">
                    <a class="nav-link dropdown-toggle navbar-text" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fa-solid fa-book-bookmark"></i> Tutorials
                    </a>
                    <!-- Dropdown menu -->
                    <ul class="dropdown-menu dropdown-custom" aria-labelledby="navbarDropdown">
                        <li>
                ...
                <li class="nav-item dropdown d-flex align-items-center">
                    <a class="nav-link dropdown-toggle navbar-text" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fa-solid fa-user-secret"></i> Staff
                    </a>
                    <!-- Dropdown menu -->
                    <ul class="dropdown-menu dropdown-custom" aria-labelledby="navbarDropdown">
                        <li>
                ...
                <li class="nav-item dropdown d-flex align-items-center">
                    <a class="nav-link dropdown-toggle navbar-text" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fa-solid fa-certificate"></i> VIP
                    </a>
                    <!-- Dropdown menu -->
                    <ul class="dropdown-menu dropdown-custom" aria-labelledby="navbarDropdown">
                        <li>
